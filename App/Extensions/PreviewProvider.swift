...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 5.63)
    let stat2 = StatisticModel(title: "Market Cap", value: "$12.5Bn", percentageChange: -5.63)
